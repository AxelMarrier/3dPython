...
class Triangle:
    ...
    def setOrientation(self):
        cross1 = vecteur.subVecteurVecteur(self.vect1, self.origine)

        cross2 = vecteur.subVecteurVecteur(self.vect2, self.origine)

        crossProduct = vecteur.cross(cross1, cross2)

        crossProductNormaliser = vecteur.normalise(crossProduct)
